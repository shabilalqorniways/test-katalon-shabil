...
def response = WS.sendRequest(findTestObject('Object Repository/Web Service/ReqresIn/POST_RegisterSuccessful'))
...
def userId = json.id
def userToken = json.token

// Tampilkan ke log
KeywordUtil.logInfo("User ID: " + userId)
KeywordUtil.logInfo("User Token: " + userToken)
