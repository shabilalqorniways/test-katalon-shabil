...
def response = WS.sendRequest(OR.findTestObject('Object Repository/Web Service/ReqresIn/GET_SingleUser'))
...
// Simpan email
GlobalVariable.registeredUserEmail = firstUserEmail

// Tampilkan ke log
KeywordUtil.logInfo("First User ID: " + firstUserId)
KeywordUtil.logInfo("First User Email: " + GlobalVariable.registeredUserEmail)